package com.example.myapplication.home.ui.special.model;
...
public class SpecialModel extends BaseModel implements SpecialContract.SpecialModel {
    @Override
...
//        NetWorkFactory.getInstance().getNetWork().get(URLConstants.VEDIO_LIST,commonParams ,netCallback);
        NetWorkFactory.getInstance().getNetWork().get("/app/v_1_3/article/speciallist",commonParams,netCallback);
    }
}
